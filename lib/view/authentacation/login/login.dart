...
import 'package:notumcepte/view/authentacation/forgot-password/forgot_password.dart';
import 'package:notumcepte/view/authentacation/register/register_page.dart';
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                bottom: 0,
                child: Padding(
                  padding: EdgeInsets.only(left: SizeConfig.screenWidth! / 5),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
